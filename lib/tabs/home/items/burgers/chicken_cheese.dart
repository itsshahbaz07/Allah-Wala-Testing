...
class ChickenCheeseDetails extends StatefulWidget {
  const ChickenCheeseDetails({super.key});

  @override
  State<ChickenCheeseDetails> createState() => _ChickenCheeseDetailsState();
}

class _ChickenCheeseDetailsState extends State<ChickenCheeseDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Succulent chicken patty crowned with gooey cheese.",
                                style: TextStyle(
