...
class BeefCheeseDetails extends StatefulWidget {
  const BeefCheeseDetails({super.key});

  @override
  State<BeefCheeseDetails> createState() => _BeefCheeseDetailsState();
}

class _BeefCheeseDetailsState extends State<BeefCheeseDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Rich beef patty topped with melted cheese.",
                                style: TextStyle(
