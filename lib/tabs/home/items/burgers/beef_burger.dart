...
class BeefBurgerDetails extends StatefulWidget {
  const BeefBurgerDetails({super.key});

  @override
  State<BeefBurgerDetails> createState() => _BeefBurgerDetailsState();
}

class _BeefBurgerDetailsState extends State<BeefBurgerDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Juicy beef patty nestled in a soft bun.",
                                style: TextStyle(
