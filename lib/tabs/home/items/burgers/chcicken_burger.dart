...
class ChickenBurgerDetails extends StatefulWidget {
  const ChickenBurgerDetails({super.key});

  @override
  State<ChickenBurgerDetails> createState() => _ChickenBurgerDetailsState();
}

class _ChickenBurgerDetailsState extends State<ChickenBurgerDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Tender chicken patty hugged by a bun.",
                                style: TextStyle(
