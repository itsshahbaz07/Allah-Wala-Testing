...
class _BurgersPageState extends State<BurgersPage> {
  ...
  void initState() {
    ...
    items = [
      {
        'title': 'Beef Burger',
        'description': 'Juicy beef patty nestled in a soft bun.',
        ...
        'onTap': () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const BeefBurgerDetails(),
            ),
          );
        }
      },
      {
        ...
        'description': 'Rich beef patty topped with melted cheese.',
        'imageURL': 'assets/images/burger-removebg-preview.png',
        'price': 360,
        'isFavorite': false,
        'onTap': () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const BeefCheeseDetails(),
            ),
          );
        }
      },
      {
        ...
        'description': 'Tender chicken patty hugged by a bun.',
        'imageURL': 'assets/images/burger-removebg-preview.png',
        'price': 300,
        'isFavorite': false,
        'onTap': () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const ChickenBurgerDetails(),
            ),
          );
        }
      },
      {
        ...
        'description': 'Succulent chicken patty crowned with gooey cheese.',
        'imageURL': 'assets/images/burger-removebg-preview.png',
        'price': 360,
        'isFavorite': false,
        'onTap': () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const ChickenCheeseDetails(),
            ),
          );
        }
      },
