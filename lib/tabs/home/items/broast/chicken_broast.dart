...
class ChickenBroastDetails extends StatefulWidget {
  const ChickenBroastDetails({super.key});

  @override
  State<ChickenBroastDetails> createState() => _ChickenBroastDetailsState();
}

class _ChickenBroastDetailsState extends State<ChickenBroastDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Delightful, juicy, crispy chicken chest",
                                style: TextStyle(
