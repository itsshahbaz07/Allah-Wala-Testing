...
class LegBroastDetails extends StatefulWidget {
  const LegBroastDetails({super.key});

  @override
  State<LegBroastDetails> createState() => _LegBroastDetailsState();
}

class _LegBroastDetailsState extends State<LegBroastDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Succulent, tender, flavorful chicken leg",
                                style: TextStyle(
