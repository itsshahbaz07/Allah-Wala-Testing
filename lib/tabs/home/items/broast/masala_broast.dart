...
class MasalaBroastDetails extends StatefulWidget {
  const MasalaBroastDetails({super.key});

  @override
  State<MasalaBroastDetails> createState() => _MasalaBroastDetailsState();
}

class _MasalaBroastDetailsState extends State<MasalaBroastDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Spicy, aromatic, seasoned broasted chicken",
                                style: TextStyle(
