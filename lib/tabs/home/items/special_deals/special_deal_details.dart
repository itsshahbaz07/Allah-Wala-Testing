...
class SpecialDealDetails extends StatefulWidget {
  const SpecialDealDetails({super.key});

  @override
  State<SpecialDealDetails> createState() => _SpecialDealDetailsState();
}

class _SpecialDealDetailsState extends State<SpecialDealDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Biryani loaded with spicy marinated chicken piece, caramelized onions & flavour saffron rice",
                                style: TextStyle(
