...
class SpecialDealsPage extends StatefulWidget {
  ...
  @override
  State<SpecialDealsPage> createState() => _SpecialDealsPageState();
}
    ...
    items = [
      {
        ...
        'description': 'Extra Large Chicken Biryani/Beef Biryani/Beef Pulao',
        ...
        'onTap': () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const SpecialDealDetails(),
            ),
          );
        }
      },
