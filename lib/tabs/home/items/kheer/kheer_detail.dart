...
class KheerDetails extends StatefulWidget {
  const KheerDetails({super.key});

  @override
  State<KheerDetails> createState() => _KheerDetailsState();
}

class _KheerDetailsState extends State<KheerDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Creamy, aromatic rice pudding, a delightful dessert.",
                                style: TextStyle(
