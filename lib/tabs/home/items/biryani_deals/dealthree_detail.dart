...
class DealThreeDetails extends StatefulWidget {
  const DealThreeDetails({super.key});

  @override
  State<DealThreeDetails> createState() => _DealThreeDetailsState();
}

class _DealThreeDetailsState extends State<DealThreeDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "1 Beef Biryani Single/2 Chicken Rolls/1Raita/2 Cold drinks",
                                style: TextStyle(
