...
class DealFourDetails extends StatefulWidget {
  const DealFourDetails({super.key});

  @override
  State<DealFourDetails> createState() => _DealFourDetailsState();
}

class _DealFourDetailsState extends State<DealFourDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Beef Biryani/Raita/1 Buddy Pack 345 ML",
                                style: TextStyle(
