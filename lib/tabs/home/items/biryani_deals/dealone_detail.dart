...
class DealOneDetails extends StatefulWidget {
  const DealOneDetails({super.key});

  @override
  State<DealOneDetails> createState() => _DealOneDetailsState();
}

class _DealOneDetailsState extends State<DealOneDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "1 Chicken Biryani Single/2 Chicken Rolls/1Raita/2 Cold drinks",
                                style: TextStyle(
