import 'package:allah_wala_biryani_app/tabs/home/items/kabab/kabab_details.dart';
    ...
    items = [
      {
        ...
        'description': 'Savory, spiced, tender minced beef patties.',
        'imageURL': 'assets/images/shami_kabab-removebg-preview.png',
        'price': 80,
        'isFavorite': false,
        'onTap': () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const KababDetails(),
            ),
          );
        }
      },
