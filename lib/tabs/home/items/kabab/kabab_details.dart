...
class KababDetails extends StatefulWidget {
  const KababDetails({super.key});

  @override
  State<KababDetails> createState() => _KababDetailsState();
}

class _KababDetailsState extends State<KababDetails> {
  double price = 15;
  int qty = 1;
  bool isFav = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              const EdgeInsets.symmetric(horizontal: 25),
                              child: Text(
                                "Savory, spiced, tender minced beef patties.",
                                style: TextStyle(
